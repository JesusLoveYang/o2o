...
$(function() {
	...
	// 获取当前店铺设定的商品类别列表的URL
	var categoryUrl = '/o2o/shopadmin/getpclistbyshopid';
	// 更新商品信息的URL
				...
				.getJSON(
						...
						function(data) {
							if (data.success) {
								...
								$('#product-desc').val(product.productDes);
								$('#priority').val(product.productWeight);
	...
	$('#submit').click(
			function() {
				...
				product.productDes = $('#product-desc').val();
				product.productWeight = $('#priority').val();
				product.normalPrice = $('#normal-price').val();
				product.reducePrice = $('#promotion-price').val();
				// 获取选定的商品类别值
